...
const SearchBar = props => {
    return(
        <div className="w3-bar">
            ...
            <input type="text" placeholder="Search" className="w3-bar-item w3-input search update" onKeyDown={props.searchPost}/>
            ...
            <a href="#user" className="w3-bar-item w3-button w3-right update"><i className="far fa-user-circle fa-lg"></i></a>
        </div>
    )
}
